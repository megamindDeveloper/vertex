...
export default function GetAQuoteSection({
  ...
  return (
    <section className="relative bg-[#0097DC] text-white py-16 px-6 md:px-12 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-6">
          ...
          <p className="text-white/90 text-base max-w-md">
            Schedule a walkthrough today and discover how work feels when
...
<path d="M647.214 2L341.277 450.268L340.539 451.349L341.235 452.458L507.072 716.609H360.42L257.081 535.758L255.345 532.719L253.607 535.758L150.269 716.609H3.63379L170.925 452.465L171.606 451.388L170.919 450.315L11.0703 201.033H158.411L255.812 369.271L257.426 372.057L259.209 369.376L503.625 2H647.214Z" stroke="#26428B" stroke-width="4"/>
</svg>
